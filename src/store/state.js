...
const blueprints = [
  {
    ...
    resources: [{ material: constants.copper.material, quantity: 2, materialName: constants.copper.name },
      { material: constants.gold.material, quantity: 1, materialName: constants.gold.name }],
  },
  {
    name: constants.copperWire.name,
    craftedResource: [{ material: constants.copperWire.material, quantity: 1 }],
    profit: materialProfits.find(element => element.material == constants.copperWire.material).profit,
    resources: [{ material: constants.copper.material, quantity: 2, materialName: constants.copper.name }],
  },
  {
  ...
  },
  {
    ...
    profit: materialProfits.find(element => element.material == constants.processingUnit.material).profit,
    resources: [{ material: constants.circuit.material, quantity: 2, materialName: constants.circuit.name },
      { material: constants.processed_gold.material, quantity: 1, materialName: constants.processed_gold.name }],
  },
  {
    ...
    resources: [
      { material: constants.processed_iron.material, quantity: 5, materialName: constants.processed_iron.name },
      { material: constants.processingUnit.material, quantity: 5, materialName: constants.processingUnit.name },
      { material: constants.gear.material, quantity: 5, materialName: constants.gear.name },
    ],
  },
];
